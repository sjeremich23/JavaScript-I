...
for (let i = 0; i < inventory.length; i++) {
	carModels.push(inventory[i].car_model); //push only car models of all listed cars into empty array.
}
carModels.sort();
...
carYears.sort(function(a, b) {
	return a - b; // sort out years in numeric order ot make life easier
});
